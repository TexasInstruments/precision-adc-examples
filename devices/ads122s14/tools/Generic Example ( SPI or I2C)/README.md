...
The ADS122S14 example code can be used for all devices in the family including ADS1114, ADS1113, ADS1015, ADS1014, ADS1013, and TLA2024 variants.  To assist in expediting this process, this example code is intended to show how to initialize and communicate with the ADS122S14 at a high-level.
...
1.  **`ADS122S14`**
	...
	*Description:* High-level functions and register map definitions for communicating with the ADS122S14.
	
	*Files: ADS122S14.h, ADS122S14.c*

2.  **`Hardware Abstraction Layer (HAL)`**

	*Description:* The HAL provides processor specific functions called by the `ADS122S14` module.
...
Reference the *ads122s14.c* file while writing your own code for examples of how how to perform basic ADC operations, such as register read/writes and reading data...

OR

Copy and paste the example code into your project, and update the files as needed to get access to the provided APIs...

 1. Copy the `ADS122S14` and `HAL` module files into your firmware project.
 ...
 3. Edit all of the function implementations inside of *hal.c* to provide the specified functionality with your processor and processor-specific library APIs. 
    ...
    */
    ...
    //
    // Configuring the pin muxing for SPI functions.
    //

    //
    // Enabling and initializing the SPI master module.
    //

	```
	NOTE 1: The *hal.c* functions are called from within *ads122s14.c* to interface with the hardware. The hardware functionality is kept in a separate module to allow the `ads122s14` module to remain portable.
 ...
 5. Include a reference to *ads122s14.h* in your application (from *main.c* or wherever ADC communication is handled). You should now be able to begin calling the `ads122s14` module functions in your code.
...
|:-----------:| ----------- | ---------------------- |
| 1.0.0       | 09/05/2021  | Initial release        |
