![IC Image](http://www.ti.com/graphics/folders/partimages/ADS131M04.jpg)ADS131M0x Example Code
=====================
...
#else
 1. Copy the `ADS131M0x` and `HAL` module files into your firmware project. Optionally, copy the `Unit Tests` module into your project as well.
#endif
