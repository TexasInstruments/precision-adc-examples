...
// Variadic function (see: https://en.wikipedia.org/wiki/Variadic_function)
...
//*****************************************************************************
//
//! A simple USB based vprintf function supporting \%c, \%d, \%p, \%s, \%u,
//! \%x, and \%X.
//!
...
//! All of its output will be sent to the USB.  Only the following formatting
...
void USBvprintf(const char *pcString, va_list vaArgP)
{
    ...
    while(*pcString)
    {
        ...
        USBBufferWrite(CDC_TX_BUFFER, (uint8_t*)pcString, ui32Idx);
...
again:
            ...
            switch(*pcString++)
            {
                ...
                case 'c':
                {
                    ...
                    USBBufferWrite(CDC_TX_BUFFER, (uint8_t *)&ui32Value, 1);
                ...
                case 's':
                {
                    ...
                    USBBufferWrite(CDC_TX_BUFFER, (uint8_t*)pcStr, ui32Idx);
                    ...
                    if(ui32Count > ui32Idx)
                    {
                        ...
                        {
                            //UARTwrite(" ", 1);
                            USBBufferWrite(CDC_TX_BUFFER, (uint8_t*) " ", 1);
                        }
                    }
...
convert:
                    ...
                    USBBufferWrite(CDC_TX_BUFFER, (uint8_t*)pcBuf, ui32Pos);
                ...
                case '%':
                {
                    ...
                    USBBufferWrite(CDC_TX_BUFFER, (uint8_t*)pcString - 1, 1);
                ...
                default:
                {
                    ...
                    //
                    //UARTwrite("ERROR", 5);
                    USBBufferWrite(CDC_TX_BUFFER, (uint8_t*)"ERROR", 5);
