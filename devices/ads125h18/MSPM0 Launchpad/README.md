...
## ADC Configuration Code Generation Tool
 Visit [PADC Design Calculator](https://dev.ti.com/gallery/view/PADC/PADC_Design_Calculator_Tool/?device=ADS125H18) to use the Sequence Configuration tool

**Example:**
```C
// Generated by the ADS125H18 Sequencer Configuration Tool on 1/8/2026, 3:55:30 PM
