//*****************************************************************************
//
// usbenum.c - Enumeration code to handle all endpoint zero traffic. modified
//
// Copyright (c) 2007-2019 Texas Instruments Incorporated.  All rights reserved.
...
/*
List of header files in usbdenum.c
...
USBDCDDeviceInfoInit(uint32_t ui32Index, tDeviceInfo *psDeviceInfo)
{
    ...
    //if(CLASS_IS_TM4C129)
    //{
        g_psDCDInst[0].ui32IntNum = INT_USB0;//58; //432E is being used same as 1294 Tiva INT_USB0_TM4C129;
    //}
...
USBDReadAndDispatchRequest(uint32_t ui32Index)
{
    ...
    {
        // modified for "WinUSB Device" implementation - BB 10/17/18.
        //
        // MS OS string descriptor
        //
extern bool MSOSdescHandleVendorRequests( tUSBRequest * pUSBRequest );
        if ( MSOSdescHandleVendorRequests( psRequest ) )   return;
...
USBDGetDescriptor(void *pvInstance, tUSBRequest *psUSBRequest)
{
 ...
 extern bool MSOSdescHandleStringRequest( tUSBRequest * psUSBRequest, uint8_t ** ppui8EP0Data, volatile uint32_t * pui32EP0DataRemain );
    ...
    switch(psUSBRequest->wValue >> 8)
    {
       ...
       // BOS Descriptor request
        case 15:
            ...
            MSOSdescHandleStringRequest( psUSBRequest,
