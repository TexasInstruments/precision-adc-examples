//*****************************************************************************
//
// usbdbulk.c - USB bulk device class driver. modified
//
...
#ifdef USE_MS_OS_20
    USBShort(0x0201),           // USB version 2.0, MSOS 2.0 descriptor.
#else
    USBShort(0x0200),           // USB version 2.0, MSOS 1.0 descriptor.
#endif                          //      modified for WinUSB Device, Bob Benjamin 12_7_2018
...
// Added code segment for MSOS descriptors as a request handler 
// Code segment added 12_7_2018 by Bob Benjamin
extern void MSOSdescHandleVendorRequests(void *pvBulkDevice, tUSBRequest *pUSBRequest);
...
const tCustomHandlers g_sBulkHandlers =
{
    ...
    //
    //0,
    MSOSdescHandleVendorRequests,    // <---- changed for WinUSB Device, by Bob Benjamin
